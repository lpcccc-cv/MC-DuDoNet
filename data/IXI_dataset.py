    ...
    def __getitem__(self, idx):
        ...
        if self.task == 'rec':
            if self.scale == 4:
                ...
                mask_path = '/home/lpc/program/MC_VANet_Loupe/Loupe_mask/x10_mask_hard_IXI.png'
            elif self.scale == 20:
                mask_path = '/home/lpc/program/MC_VANet_Loupe/Loupe_mask/x20_mask_hard_IXI.png'
            elif self.scale == 30:
                mask_path = '/home/lpc/program/MC_VANet_Loupe/Loupe_mask/x30_mask_hard_IXI.png'
            else:
