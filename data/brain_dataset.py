...
class brain_train(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.task == 'rec':
            if self.scale == 4:
                mask_path = '/home/lpc/dataset/BrainTS/mask_x4_brain.png'
            elif self.scale == 8:
                mask_path = '/home/lpc/dataset/BrainTS/mask_x8_brain.png'
            elif self.scale == 10:
                mask_path = '~/Loupe_mask/mask_brain_hard.png'
            elif self.scale == 20:
                mask_path = '~/Loupe_mask/mask_hard_brainx20.png'
            elif self.scale == 30:
                mask_path = '~/Loupe_mask/mask_hard_brainx30.png'
            else:
