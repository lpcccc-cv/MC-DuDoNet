...
class knee_train(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.task == 'rec':
            if self.scale == 4:
                mask_path = '~/dataset/IXI/MC_MRI/mask_x4.png'
            elif self.scale == 8:
                mask_path = '~/dataset/IXI/MC_MRI/mask_x8.png'
            elif self.scale == 10:
                mask_path = '~/program/MC_VANet_Loupe/Loupe_mask/x10_mask_hard_knee.png'
            elif self.scale == 20:
                mask_path = '~/program/MC_VANet_Loupe/Loupe_mask/x20_mask_hard_knee.png'
            elif self.scale == 30:
                mask_path = '~/program/MC_VANet_Loupe/Loupe_mask/x30_mask_hard_knee.png'
            else:
                print('Wrong scale for reconstruction!')
        elif self.task == 'sr':
            if self.scale == 2:
                mask_path = '~/dataset/IXI/MCSR/mask_sr_x2.png'
            elif self.scale == 4:
                mask_path = '~/dataset/IXI/MCSR/mask_sr_x4.png'
            else:
